...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('plan', sa.Enum('trial', 'starter', 'professional', 'enterprise', name='plan_enum'),
    ...
    op.create_table(
        ...
        sa.Column('status', sa.Enum('open', 'in_progress', 'resolved', 'closed', name='ticket_status_enum'),
                  nullable=False, server_default='open'),
        sa.Column('priority', sa.Enum('low', 'medium', 'high', 'critical', name='ticket_priority_enum'),
